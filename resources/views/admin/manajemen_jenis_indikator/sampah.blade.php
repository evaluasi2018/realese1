  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    overflow-y: auto;">
      <div class="button" style="margin-bottom: 5px;">
        <a href="{{ route('sampah.restore_all') }}" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i>&nbsp;Kembalikan Semuanya</a>
        &nbsp;
        <a href="{{ route('sampah.force_all') }}" class="btn btn-danger btn-flat"><i class="fa fa-remove"></i>&nbsp;Hapus Semuanya</a>
      </div>

        <table class="table table-bordered" id="table-sampah-jenis" style="width: 100%;">
          <thead>
            <tr>
              <th>NO</th>
